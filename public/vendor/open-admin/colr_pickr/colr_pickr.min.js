...
!(function () {
    ...
    if (
        ...
        for (
            let t = colorPickerComp.LSCustomColors[0].length - 1;
            t >= 0;
            t--
        ) {
    ...
    (colorPickerComp.keyShortcuts = function (t) {
        for (let t in document.getElementsByTagName("INPUT"))
            if (
                !isNaN(t) &&
                document.getElementsByTagName("INPUT")[t] ===
        ...
        for (let t in document.getElementsByTagName("TEXTAREA"))
            if (
                !isNaN(t) &&
                document.getElementsByTagName("TEXTAREA")[t] ===
                    document.activeElement
            )
                return;
        switch (t.keyCode) {
    ...
    document.addEventListener("mousedown", function () {
        "color_context_menu" != event.target.id &&
            (document.getElementById("color_context_menu").style.display =
                "none");
    });
...
document.addEventListener("mousedown", function () {
        ...
        .addEventListener("contextmenu", function (t) {
            if ("custom_colors_preview" == t.target.className) {
                ...
                (e.style.display = "block"),
                    (e.style.top =
                        t.target.getBoundingClientRect().top + 25 + "px"),
                    (e.style.left =
                        t.target.getBoundingClientRect().left + "px"),
    ...
    (colorPickerComp.colorSliderHandler = function (t) {
        ...
        (colorPickerComp.hue = r),
            ...
            colorPickerComp.instance.element.setAttribute(
                "data-color",
                "color"
            ),
            updatePicker();
    ...
    document.addEventListener(
        ...
        function () {
            !0 === colorPickerComp.sliderStatusTouch &&
                ...
                colorPickerComp.colorSliderHandler(
    ...
    document.getElementById("opacity_slider").addEventListener(
        ...
        function (t) {
            (colorPickerComp.opacityStatusTouch = !0),
                colorPickerComp.opacitySliderHandler(
    ...
    (colorPickerComp.updateColorDisplays = function (t) {
        if ("undefined" == t) t = { h: 0, s: 100, l: 50, a: 1 };
            ...
            t = colorPickerComp.hexAToRGBA(t, !0);
